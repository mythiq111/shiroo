...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Happy Birthday Shirooo" },
      { name: "description", content: "A cinematic birthday keepsake made with love for Shirooo." },
      { name: "author", content: "A best friend" },
      { property: "og:title", content: "Happy Birthday Shirooo" },
      { property: "og:description", content: "A cinematic birthday keepsake made with love for Shirooo." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400&family=Inter:wght@300;400;500&display=swap" },
    ],
  }),
